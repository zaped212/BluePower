...
public class BPBlocks {
    ...
    private static void instantiateBlocks() {
        ...
        blockAlloyWire = new Block[MinecraftColor.VALID_COLORS.length + 1];
        ...
        for (int i = 0; i < MinecraftColor.VALID_COLORS.length; i++) {
            ...
            blockAlloyWire[i + 1] = new BlockInsulatedAlloyWire(RedwireType.RED_ALLOY.getName(), MinecraftColor.VALID_COLORS[i]);
        }
    }
